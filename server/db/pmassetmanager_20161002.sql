...
INSERT INTO `authassignment` VALUES ('Super Admin', '1', null, null);
...
-- ----------------------------
INSERT INTO `tbl_asset` VALUES ('1', 'Asset 2', '4', 'Lan 4', null, null, 'ASSET_26', '1', '1475399112', '1475351735', '1');
INSERT INTO `tbl_asset` VALUES ('8', 'Asset 3', '3', 'Test only', '12', '264', '', '1', '1475399124', '1475351735', '1');
INSERT INTO `tbl_asset` VALUES ('26', 'Asset 1', '4', 'Tôi đến đây', '3333', null, 'ASSET_26', '1', '1475399102', '1475374361', '1');
INSERT INTO `tbl_asset` VALUES ('27', 'Asset 5', '3', 'Test 3', '3', null, '', '1', '1475399132', '1475351735', '1');

-- ----------------------------
-- Table structure for `tbl_asset_category`
-- ----------------------------
...
-- ----------------------------
-- Records of tbl_asset_category
-- ----------------------------
INSERT INTO `tbl_asset_category` VALUES ('1', 'Asset Category 1', '1', '1429035668');
INSERT INTO `tbl_asset_category` VALUES ('2', 'Asset Category 2', '1', '1429035668');
INSERT INTO `tbl_asset_category` VALUES ('3', 'Asset Category 3', '1', '1429035668');
INSERT INTO `tbl_asset_category` VALUES ('4', 'Asset Category 4', '1', '1429035677');
INSERT INTO `tbl_asset_category` VALUES ('5', 'Asset Category 5', '1', '1448021282');

-- ----------------------------
-- Table structure for `tbl_asset_file`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_asset_file`;
CREATE TABLE `tbl_asset_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
  `file_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_graphic_file` (`asset_id`,`file_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of tbl_asset_file
-- ----------------------------
INSERT INTO `tbl_asset_file` VALUES ('3', '15', '268');
INSERT INTO `tbl_asset_file` VALUES ('4', '15', '269');
INSERT INTO `tbl_asset_file` VALUES ('5', '15', '270');
INSERT INTO `tbl_asset_file` VALUES ('6', '15', '271');
INSERT INTO `tbl_asset_file` VALUES ('7', '15', '272');
...
-- Records of tbl_file
-- ----------------------------
INSERT INTO `tbl_file` VALUES ('1', 'hung_nt_4', 'png', 'data/upload/image/2015/04/03', '474385', '1', '1428045440', '1', '0');
INSERT INTO `tbl_file` VALUES ('2', 'hung_nt_5', 'png', 'data/upload/image/2015/04/03', '474385', '1', '1428045640', '1', '0');
INSERT INTO `tbl_file` VALUES ('3', 'load_certificate', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428045890', '1', '0');
INSERT INTO `tbl_file` VALUES ('4', 'load_certificate_1', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428045920', '1', '0');
INSERT INTO `tbl_file` VALUES ('5', 'load_certificate_2', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428045970', '1', '0');
INSERT INTO `tbl_file` VALUES ('6', 'Mua_Chung', 'jpg', 'data/upload/image/2015/04/03', '403294', '1', '1428050469', '1', '0');
INSERT INTO `tbl_file` VALUES ('7', 'load_certificate_3', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428052487', '1', '0');
INSERT INTO `tbl_file` VALUES ('8', 'load_certificate_4', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428052914', '1', '0');
INSERT INTO `tbl_file` VALUES ('9', 'load_certificate_5', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428053925', '1', '0');
INSERT INTO `tbl_file` VALUES ('10', 'load_certificate_6', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054124', '1', '0');
INSERT INTO `tbl_file` VALUES ('11', 'load_certificate_7', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054269', '1', '0');
INSERT INTO `tbl_file` VALUES ('12', 'load_certificate_8', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054291', '1', '0');
INSERT INTO `tbl_file` VALUES ('13', 'load_certificate_9', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054340', '1', '0');
INSERT INTO `tbl_file` VALUES ('14', 'load_certificate_10', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054436', '1', '0');
INSERT INTO `tbl_file` VALUES ('15', 'load_certificate_11', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054477', '1', '0');
INSERT INTO `tbl_file` VALUES ('16', 'load_certificate_12', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054560', '1', '0');
INSERT INTO `tbl_file` VALUES ('17', 'load_certificate_13', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054629', '1', '0');
INSERT INTO `tbl_file` VALUES ('18', 'load_certificate_14', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054678', '1', '0');
INSERT INTO `tbl_file` VALUES ('19', 'load_certificate_15', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054712', '1', '0');
INSERT INTO `tbl_file` VALUES ('20', 'load_certificate_16', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054829', '1', '0');
INSERT INTO `tbl_file` VALUES ('21', 'Mua_Chung_1', 'jpg', 'data/upload/image/2015/04/03', '403294', '1', '1428054844', '1', '0');
INSERT INTO `tbl_file` VALUES ('22', 'load_certificate_17', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428054896', '1', '0');
INSERT INTO `tbl_file` VALUES ('23', 'load_certificate_18', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428055665', '1', '0');
INSERT INTO `tbl_file` VALUES ('24', 'load_certificate_19', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428055717', '1', '0');
INSERT INTO `tbl_file` VALUES ('25', 'load_certificate_20', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428055882', '1', '0');
INSERT INTO `tbl_file` VALUES ('26', 'load_certificate_21', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428055901', '1', '0');
INSERT INTO `tbl_file` VALUES ('27', 'load_certificate_22', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428055968', '1', '0');
INSERT INTO `tbl_file` VALUES ('28', 'load_certificate_23', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056555', '1', '0');
INSERT INTO `tbl_file` VALUES ('29', 'load_certificate_24', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056560', '1', '0');
INSERT INTO `tbl_file` VALUES ('30', 'load_certificate_25', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056769', '1', '0');
INSERT INTO `tbl_file` VALUES ('31', 'load_certificate_26', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056798', '1', '0');
INSERT INTO `tbl_file` VALUES ('32', 'load_certificate_27', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056814', '1', '0');
INSERT INTO `tbl_file` VALUES ('33', 'load_certificate_28', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056867', '1', '0');
INSERT INTO `tbl_file` VALUES ('34', 'load_certificate_29', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056929', '1', '0');
INSERT INTO `tbl_file` VALUES ('35', 'load_certificate_30', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428056979', '1', '0');
INSERT INTO `tbl_file` VALUES ('36', 'load_certificate_31', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428057078', '1', '0');
INSERT INTO `tbl_file` VALUES ('37', 'load_certificate_32', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428057264', '1', '0');
INSERT INTO `tbl_file` VALUES ('38', 'Mua_Chung_2', 'jpg', 'data/upload/image/2015/04/03', '403294', '1', '1428057284', '1', '0');
INSERT INTO `tbl_file` VALUES ('39', 'Mua_Chung_3', 'jpg', 'data/upload/image/2015/04/03', '403294', '1', '1428057373', '1', '0');
INSERT INTO `tbl_file` VALUES ('45', 'load_certificate_36', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428075521', '1', '0');
INSERT INTO `tbl_file` VALUES ('47', 'load_certificate_38', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428079036', '0', '0');
INSERT INTO `tbl_file` VALUES ('48', 'load_certificate_39', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428079644', '0', '0');
INSERT INTO `tbl_file` VALUES ('49', 'load_certificate_40', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428079719', '2', '0');
INSERT INTO `tbl_file` VALUES ('50', 'load_certificate_46', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428080490', '2', '0');
INSERT INTO `tbl_file` VALUES ('51', 'load_certificate_47', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428080552', '1', '0');
INSERT INTO `tbl_file` VALUES ('52', 'DWG_load_certificate', 'png', 'data/upload/image/2015/04/03', '25937', '1', '1428081035', '1', '0');
INSERT INTO `tbl_file` VALUES ('53', 'PDF_Tamkinh_104cmx68_5cm', 'png', 'data/upload/image/2015/04/04', '121198', '1', '1428125136', '2', '0');
INSERT INTO `tbl_file` VALUES ('54', 'DWG_aaaa', 'png', 'data/upload/image/2015/04/05', '60930', '1', '1428261377', '1', '0');
INSERT INTO `tbl_file` VALUES ('55', 'PDF_aaaa', 'png', 'data/upload/image/2015/04/05', '60930', '1', '1428261405', '2', '0');
INSERT INTO `tbl_file` VALUES ('56', 'CERT_AM Designation Mill Cert', 'pdf', 'data/upload/other/2015/04/06', '4410345', '1', '1428355181', '3', '0');
INSERT INTO `tbl_file` VALUES ('57', 'DWG_banner_fb_2-0412', 'jpg', 'data/upload/image/2015/04/08', '84833', '1', '1428473547', '1', '0');
INSERT INTO `tbl_file` VALUES ('65', 'SHAPE_shape_square', 'png', 'data/upload/image/2015/04/09', '1096', '1', '1428599757', '0', '0');
INSERT INTO `tbl_file` VALUES ('66', 'SHAPE_shape_tb', 'png', 'data/upload/image/2015/04/09', '3182', '1', '1428599760', '0', '0');
INSERT INTO `tbl_file` VALUES ('70', 'OTHER_Quote_KELOWNA_TEST', 'pdf', 'data/upload/other/2015/04/15', '7623', '1', '1429112760', '0', '0');
INSERT INTO `tbl_file` VALUES ('72', 'OTHER_15984671010_82a8608383_k', 'jpg', 'data/upload/image/2015/04/15', '821381', '1', '1429112859', '0', '0');
INSERT INTO `tbl_file` VALUES ('73', 'OTHER_Corner Close Display (1)', 'png', 'data/upload/image/2015/04/15', '28606', '1', '1429112995', '0', '0');
INSERT INTO `tbl_file` VALUES ('74', 'OTHER_button', 'JPG', 'data/upload/other/2015/04/15', '8926', '1', '1429113049', '0', '0');
INSERT INTO `tbl_file` VALUES ('75', '[123doc.vn] - thi nghiem vat lieu dien_2', 'pdf', 'data/upload/other/2015/04/15', '2192', '1', '1429113050', '0', '0');
INSERT INTO `tbl_file` VALUES ('77', 'OTHER_carrier confirm ', 'pdf', 'data/upload/other/2015/04/15', '103002', '1', '1429114990', '0', '0');
INSERT INTO `tbl_file` VALUES ('78', 'OTHER_Lecture-Notes-1', 'pdf', 'data/upload/other/2015/04/15', '565748', '1', '1429115080', '0', '0');
INSERT INTO `tbl_file` VALUES ('79', 'OTHER_ket_handbook', 'pdf', 'data/upload/other/2015/04/15', '3930786', '1', '1429115103', '0', '0');
INSERT INTO `tbl_file` VALUES ('80', 'OTHER_Hexagonal_bar', 'png', 'data/upload/image/2015/04/17', '5924', '1', '1429236017', '0', '0');
INSERT INTO `tbl_file` VALUES ('81', 'OTHER_Square_bar', 'png', 'data/upload/image/2015/04/17', '5195', '1', '1429236035', '0', '0');
INSERT INTO `tbl_file` VALUES ('82', 'OTHER_Rectangular_bar', 'png', 'data/upload/image/2015/04/17', '5176', '1', '1429236059', '0', '0');
INSERT INTO `tbl_file` VALUES ('83', 'OTHER_Round_bar', 'png', 'data/upload/image/2015/04/17', '5536', '1', '1429236085', '0', '0');
INSERT INTO `tbl_file` VALUES ('84', 'Hexagonal_bar_1', 'png', 'data/upload/image/2015/04/17', '5924', '1', '1429236578', '0', '0');
INSERT INTO `tbl_file` VALUES ('85', 'OTHER_Hexagonal_bar', 'png', 'data/upload/image/2015/04/19', '5924', '1', '1429436193', '0', '0');
INSERT INTO `tbl_file` VALUES ('86', 'Hexagonal_bar_1', 'png', 'data/upload/image/2015/04/19', '5924', '1', '1429437782', '0', '0');
INSERT INTO `tbl_file` VALUES ('87', 'Hexagonal_bar_2', 'png', 'data/upload/image/2015/04/19', '5924', '1', '1429437818', '0', '0');
INSERT INTO `tbl_file` VALUES ('88', 'Material 20150419', 'png', 'data/upload/image/2015/04/19', '380663', '1', '1429471075', '-1', '0');
INSERT INTO `tbl_file` VALUES ('89', 'OTHER_3', 'png', 'data/upload/image/2015/04/22', '22499', '1', '1429674180', '0', '0');
INSERT INTO `tbl_file` VALUES ('91', 'OTHER_CASTING', 'JPG', 'data/upload/other/2015/05/06', '24501', '1', '1430876778', '0', '0');
INSERT INTO `tbl_file` VALUES ('92', 'OTHER_TUBING', 'JPG', 'data/upload/other/2015/05/06', '19577', '1', '1430876817', '0', '0');
INSERT INTO `tbl_file` VALUES ('96', 'OTHER_316threadedrod', 'pdf', 'data/upload/other/2015/05/27', '265017', '1', '1432740790', '0', '0');
INSERT INTO `tbl_file` VALUES ('97', '316threadedrod_1', 'pdf', 'data/upload/other/2015/05/27', '265017', '1', '1432740942', '0', '0');
INSERT INTO `tbl_file` VALUES ('98', 'OTHER_Desert', 'jpg', 'data/upload/image/2015/07/29', '845941', '1', '1438138125', '0', '0');
INSERT INTO `tbl_file` VALUES ('99', 'Desert_1', 'jpg', 'data/upload/image/2015/07/29', '845941', '1', '1438138251', '0', '0');
INSERT INTO `tbl_file` VALUES ('100', 'Desert_2', 'jpg', 'data/upload/image/2015/07/29', '845941', '1', '1438138956', '0', '0');
INSERT INTO `tbl_file` VALUES ('101', 'OTHER_Hydrangeas', 'jpg', 'data/upload/image/2015/07/31', '595284', '1', '1438316054', '0', '0');
INSERT INTO `tbl_file` VALUES ('102', 'SHEET_28513OP2', 'doc', 'data/upload/other/2015/08/14', '116736', '1', '1439596023', '10', '0');
INSERT INTO `tbl_file` VALUES ('103', 'DWG_28513STEMHEAD', 'pdf', 'data/upload/other/2015/08/15', '38172', '1', '1439650508', '1', '0');
INSERT INTO `tbl_file` VALUES ('104', 'BP_CCF07292015 3', 'pdf', 'data/upload/other/2015/09/01', '560517', '1', '1441150142', '7', '0');
INSERT INTO `tbl_file` VALUES ('105', 'BP_CCF07292015 3', 'pdf', 'data/upload/other/2015/09/15', '560517', '1', '1442328486', '7', '0');
INSERT INTO `tbl_file` VALUES ('106', 'BP_YC98413-717', 'pdf', 'data/upload/other/2015/09/15', '129272', '1', '1442328838', '7', '0');
INSERT INTO `tbl_file` VALUES ('107', 'PO_RFQGFW1008', 'xlsx', 'data/upload/other/2015/09/15', '51509', '1', '1442328862', '4', '0');
INSERT INTO `tbl_file` VALUES ('108', 'PO_0690_001', 'pdf', 'data/upload/other/2015/09/15', '36471', '1', '1442329527', '4', '0');
INSERT INTO `tbl_file` VALUES ('109', 'BP_CCF06302015_0003', 'pdf', 'data/upload/other/2015/09/16', '999949', '1', '1442404379', '7', '0');
INSERT INTO `tbl_file` VALUES ('110', 'RFQEXC_RFQSNS1008', 'xlsx', 'data/upload/other/2015/09/16', '51688', '1', '1442406004', '18', '0');
INSERT INTO `tbl_file` VALUES ('111', 'BP_VA001-533-84 - 6 PISTON', 'PDF', 'data/upload/other/2015/09/16', '81778', '1', '1442406055', '7', '0');
INSERT INTO `tbl_file` VALUES ('112', 'BP_VA001-533-84 - 7 PISTON ROD', 'PDF', 'data/upload/other/2015/09/16', '88301', '1', '1442410590', '7', '0');
INSERT INTO `tbl_file` VALUES ('113', 'RFQEXC_RFQSNS1009', 'xlsx', 'data/upload/other/2015/09/16', '51457', '1', '1442410614', '18', '0');
INSERT INTO `tbl_file` VALUES ('114', 'VA001-533-84 - 7 PISTON ROD_1', 'PDF', 'data/upload/other/2015/09/16', '88301', '1', '1442411978', '7', '0');
INSERT INTO `tbl_file` VALUES ('115', 'RFQSNS1009_1', 'xlsx', 'data/upload/other/2015/09/16', '51457', '1', '1442411989', '18', '0');
INSERT INTO `tbl_file` VALUES ('118', 'TOOL_3.07mmOsg', 'JPG', 'data/upload/other/2015/09/29', '88258', '1', '1443529636', '11', '0');
INSERT INTO `tbl_file` VALUES ('119', 'RFQEXC_E2GEN28124430', 'PDF', 'data/upload/other/2015/09/29', '64874', '1', '1443529643', '18', '0');
INSERT INTO `tbl_file` VALUES ('120', 'RFQEXC_RFQnylonrollerSep28_15', 'xlsx', 'data/upload/other/2015/09/29', '52563', '1', '1443529647', '18', '0');
INSERT INTO `tbl_file` VALUES ('121', 'RFQEXC_RFQSNS1011', 'xlsx', 'data/upload/other/2015/10/12', '52505', '1', '1444692172', '18', '0');
INSERT INTO `tbl_file` VALUES ('122', 'RFQEXC_RFQGFW1013BOLT&COUPLING', 'xlsx', 'data/upload/other/2015/10/16', '52972', '1', '1445039779', '18', '0');
INSERT INTO `tbl_file` VALUES ('123', 'RFQEXC_RFQGFW1014_OCT_19_15', 'xlsx', 'data/upload/other/2015/10/19', '52655', '1', '1445298599', '18', '0');
INSERT INTO `tbl_file` VALUES ('124', 'PDF_YC70185-933', 'pdf', 'data/upload/other/2015/10/19', '115444', '1', '1445298649', '2', '0');
INSERT INTO `tbl_file` VALUES ('125', 'RFQEXC_RFQSNS14INPISTON3INTHREAD', 'xlsx', 'data/upload/other/2015/11/02', '52683', '1', '1446495599', '18', '0');
INSERT INTO `tbl_file` VALUES ('126', 'PDF_VA001-ED-001-2573 - 6 PISTON', 'PDF', 'data/upload/other/2015/11/02', '82194', '1', '1446495687', '2', '0');
INSERT INTO `tbl_file` VALUES ('127', 'PDF_VA001-ED-001-2573 - 7 PISTON ROD', 'PDF', 'data/upload/other/2015/11/03', '87810', '1', '1446511947', '2', '0');
INSERT INTO `tbl_file` VALUES ('128', 'PDF_VA-ED-001-2588 7 PISTON ROD', 'PDF', 'data/upload/other/2015/11/03', '87794', '1', '1446512160', '2', '0');
INSERT INTO `tbl_file` VALUES ('129', 'PDF_tie-in adapter plate', 'pdf', 'data/upload/other/2015/11/06', '1376910', '1', '1446836110', '2', '0');
INSERT INTO `tbl_file` VALUES ('130', 'RFQEXC_RFQ1001MR_MastPlates_Nov6_15', 'xlsx', 'data/upload/other/2015/11/06', '52719', '1', '1446836155', '18', '0');
INSERT INTO `tbl_file` VALUES ('131', 'PDF_8DIA_TOPPLATE', 'pdf', 'data/upload/other/2015/11/18', '28408', '1', '1447807970', '2', '0');
INSERT INTO `tbl_file` VALUES ('132', 'PDF_8DIA_BOTTOMPLATE', 'pdf', 'data/upload/other/2015/11/18', '23746', '1', '1447808295', '2', '0');
INSERT INTO `tbl_file` VALUES ('133', '8DIA_BOTTOMPLATE_1', 'pdf', 'data/upload/other/2015/11/18', '23746', '1', '1447808673', '2', '0');
INSERT INTO `tbl_file` VALUES ('134', '8DIA_TOPPLATE_1', 'pdf', 'data/upload/other/2015/11/18', '28408', '1', '1447808690', '2', '0');
INSERT INTO `tbl_file` VALUES ('135', 'PDF_1.0DIAx15.875LgSHAFT', 'pdf', 'data/upload/other/2015/11/18', '25380', '1', '1447853761', '2', '0');
INSERT INTO `tbl_file` VALUES ('136', 'RFQEXC_RFQGFW1023_NOV17_2015', 'xlsx', 'data/upload/other/2015/11/18', '52781', '1', '1447853769', '18', '0');
INSERT INTO `tbl_file` VALUES ('137', '1.0DIAx15.875LgSHAFT_1', 'pdf', 'data/upload/other/2015/11/18', '25380', '1', '1447854150', '2', '0');
INSERT INTO `tbl_file` VALUES ('138', 'RFQGFW1023_NOV17_2015_1', 'xlsx', 'data/upload/other/2015/11/18', '52781', '1', '1447854162', '18', '0');
INSERT INTO `tbl_file` VALUES ('139', '1.0DIAx15.875LgSHAFT_2', 'pdf', 'data/upload/other/2015/11/18', '25380', '1', '1447854374', '2', '0');
INSERT INTO `tbl_file` VALUES ('140', '1.0DIAx15.875LgSHAFT_3', 'pdf', 'data/upload/other/2015/11/18', '25380', '1', '1447854598', '2', '0');
INSERT INTO `tbl_file` VALUES ('141', 'RFQGFW1023_NOV17_2015_2', 'xlsx', 'data/upload/other/2015/11/18', '52781', '1', '1447854606', '18', '0');
INSERT INTO `tbl_file` VALUES ('142', '1.0DIAx15.875LgSHAFT_4', 'pdf', 'data/upload/other/2015/11/18', '25380', '1', '1447854851', '2', '0');
INSERT INTO `tbl_file` VALUES ('143', '1.0DIAx15.875LgSHAFT_5', 'pdf', 'data/upload/other/2015/11/18', '25380', '1', '1447855052', '2', '0');
INSERT INTO `tbl_file` VALUES ('144', 'OTHER_A1885. HT 387928. 1.000 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '89015', '1', '1448016544', '0', '0');
INSERT INTO `tbl_file` VALUES ('145', 'OTHER_A1869. HT N1B0. .2500 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '89384', '12', '1448025243', '0', '0');
INSERT INTO `tbl_file` VALUES ('146', 'OTHER_A1850. HT CH-1118. .375 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '52463', '12', '1448026856', '0', '0');
INSERT INTO `tbl_file` VALUES ('147', 'A1850. HT CH-1118. .375 INCH DIA_1', 'pdf', 'data/upload/other/2015/11/20', '52463', '12', '1448027799', '0', '0');
INSERT INTO `tbl_file` VALUES ('148', 'OTHER_A1598. HT 9SB0059-G26. .625 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '773809', '12', '1448028590', '0', '0');
INSERT INTO `tbl_file` VALUES ('149', 'OTHER_A1880. HT W0Y2. .6250 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '104784', '12', '1448028944', '0', '0');
INSERT INTO `tbl_file` VALUES ('150', 'OTHER_A1847. HT E120244. .7500 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '69636', '12', '1448029397', '0', '0');
INSERT INTO `tbl_file` VALUES ('151', 'OTHER_A1855. HT 35454. .750 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '42144', '12', '1448029572', '0', '0');
INSERT INTO `tbl_file` VALUES ('152', 'OTHER_A1822. HT 3Q384. .625 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '44829', '12', '1448029817', '0', '0');
INSERT INTO `tbl_file` VALUES ('153', 'OTHER_A1196. HT #2U288. .875 IN DIA', 'pdf', 'data/upload/other/2015/11/20', '709098', '12', '1448030049', '0', '0');
INSERT INTO `tbl_file` VALUES ('154', 'OTHER_A1610. HT H9R9. .4375 INCH DIA', 'pdf', 'data/upload/other/2015/11/20', '492146', '12', '1448031539', '0', '0');
INSERT INTO `tbl_file` VALUES ('155', 'PDF_UHMW_SLEEVE_4.5DIA', 'pdf', 'data/upload/other/2015/11/25', '39466', '1', '1448470091', '2', '0');
INSERT INTO `tbl_file` VALUES ('156', 'RFQEXC_RFQ_KUR_1001_NOV24_2015', 'xlsx', 'data/upload/other/2015/11/25', '52813', '1', '1448470110', '18', '0');
INSERT INTO `tbl_file` VALUES ('157', 'PDF_CCF11252015', 'pdf', 'data/upload/other/2015/11/26', '1324530', '1', '1448557397', '2', '0');
INSERT INTO `tbl_file` VALUES ('158', 'CCF11252015_1', 'pdf', 'data/upload/other/2015/11/26', '1324530', '1', '1448557896', '2', '0');
INSERT INTO `tbl_file` VALUES ('159', 'PDF_CCF11302015', 'pdf', 'data/upload/other/2015/11/30', '484689', '1', '1448908746', '2', '0');
INSERT INTO `tbl_file` VALUES ('161', 'PDF_CCF12022015_0001 7', 'pdf', 'data/upload/other/2015/12/09', '658881', '1', '1449666282', '2', '0');
INSERT INTO `tbl_file` VALUES ('162', 'RFQEXC_RFQ_DEC7_2015_JACKSCREW_BODY', 'xlsx', 'data/upload/other/2015/12/09', '53080', '1', '1449666296', '18', '0');
INSERT INTO `tbl_file` VALUES ('163', 'PDF_CCF12022015_0001 4', 'pdf', 'data/upload/other/2015/12/09', '578253', '1', '1449666487', '2', '0');
INSERT INTO `tbl_file` VALUES ('164', 'PDF_CCF12022015_0001 5', 'pdf', 'data/upload/other/2015/12/09', '771708', '1', '1449666496', '2', '0');
INSERT INTO `tbl_file` VALUES ('165', 'PDF_CCF12022015_0001 6', 'pdf', 'data/upload/other/2015/12/09', '740200', '1', '1449666502', '2', '0');
INSERT INTO `tbl_file` VALUES ('166', 'PDF_CCF12022015_0001 (2) 2', 'pdf', 'data/upload/other/2015/12/09', '661399', '1', '1449666899', '2', '0');
INSERT INTO `tbl_file` VALUES ('167', 'RFQEXC_RFQ_DEC7_2015_JACKSCREW_ASSEMBLY', 'xlsx', 'data/upload/other/2015/12/09', '54260', '1', '1449667268', '18', '0');
INSERT INTO `tbl_file` VALUES ('168', 'RFQ_DEC7_2015_JACKSCREW_ASSEMBLY_1', 'xlsx', 'data/upload/other/2015/12/09', '54260', '1', '1449667298', '18', '0');
INSERT INTO `tbl_file` VALUES ('169', 'PDF_CCF12022015_0001 (2) 1', 'pdf', 'data/upload/other/2015/12/09', '664552', '1', '1449667470', '2', '0');
INSERT INTO `tbl_file` VALUES ('170', 'PDF_CCF12022015_0001 (2) 3', 'pdf', 'data/upload/other/2015/12/09', '647882', '1', '1449667477', '2', '0');
INSERT INTO `tbl_file` VALUES ('171', 'PDF_CCF12022015_0001 (2) 9', 'pdf', 'data/upload/other/2015/12/09', '739308', '1', '1449667876', '2', '0');
INSERT INTO `tbl_file` VALUES ('172', 'RFQEXC_RFQ_DEC7_2015_JACKSCREWACMENUT', 'xlsx', 'data/upload/other/2015/12/09', '53099', '1', '1449667973', '18', '0');
INSERT INTO `tbl_file` VALUES ('173', 'RFQEXC_RFQ_DEC7_2015_JACKSCREW_RAMSTOP', 'xlsx', 'data/upload/other/2015/12/09', '52771', '1', '1449668116', '18', '0');
INSERT INTO `tbl_file` VALUES ('174', 'PDF_CCF12022015_0001 8', 'pdf', 'data/upload/other/2015/12/09', '667766', '1', '1449668168', '2', '0');
INSERT INTO `tbl_file` VALUES ('175', 'RFQEXC_Quotation 1601557', 'pdf', 'data/upload/other/2015/12/09', '111578', '1', '1449668398', '18', '0');
INSERT INTO `tbl_file` VALUES ('176', 'OTHER_B299. HT 1-11-1-1. 5.125 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '736623', '12', '1450109232', '0', '0');
INSERT INTO `tbl_file` VALUES ('177', 'B299. HT 1-11-1-1. 5.125 INCH DIA_1', 'pdf', 'data/upload/other/2015/12/14', '736623', '12', '1450109757', '0', '0');
INSERT INTO `tbl_file` VALUES ('178', 'B299. HT 1-11-1-1. 5.125 INCH DIA_2', 'pdf', 'data/upload/other/2015/12/14', '736623', '12', '1450110042', '0', '0');
INSERT INTO `tbl_file` VALUES ('179', 'B299. HT 1-11-1-1. 5.125 INCH DIA_3', 'pdf', 'data/upload/other/2015/12/14', '736623', '12', '1450110214', '0', '0');
INSERT INTO `tbl_file` VALUES ('180', 'B299. HT 1-11-1-1. 5.125 INCH DIA_4', 'pdf', 'data/upload/other/2015/12/14', '736623', '12', '1450110792', '0', '0');
INSERT INTO `tbl_file` VALUES ('181', 'B299. HT 1-11-1-1. 5.125 INCH DIA_5', 'pdf', 'data/upload/other/2015/12/14', '736623', '12', '1450110884', '0', '0');
INSERT INTO `tbl_file` VALUES ('182', 'OTHER_B099. HT# MA1568. 5 IN DIA', 'pdf', 'data/upload/other/2015/12/14', '131301', '12', '1450111320', '0', '0');
INSERT INTO `tbl_file` VALUES ('183', 'B099. HT# MA1568. 5 IN DIA_1', 'pdf', 'data/upload/other/2015/12/14', '131301', '12', '1450111459', '0', '0');
INSERT INTO `tbl_file` VALUES ('184', 'OTHER_B327. HT 1504102911. 3.250 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '80493', '12', '1450112110', '0', '0');
INSERT INTO `tbl_file` VALUES ('185', 'OTHER_B329. HT 1504103881. 3.000 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '42595', '12', '1450112451', '0', '0');
INSERT INTO `tbl_file` VALUES ('186', 'OTHER_B289. HT C15908 1-2-1. 4.500 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '940656', '12', '1450114465', '0', '0');
INSERT INTO `tbl_file` VALUES ('187', 'OTHER_B191. HT#1-5-1-1. 4.50 IN DIA. TEST CERT', 'doc', 'data/upload/other/2015/12/14', '3888128', '12', '1450114672', '0', '0');
INSERT INTO `tbl_file` VALUES ('188', 'B289. HT C15908 1-2-1. 4.500 INCH DIA_1', 'pdf', 'data/upload/other/2015/12/14', '940656', '12', '1450114775', '0', '0');
INSERT INTO `tbl_file` VALUES ('189', 'OTHER_B175. TEST CERT', 'pdf', 'data/upload/other/2015/12/14', '368944', '12', '1450115068', '0', '0');
INSERT INTO `tbl_file` VALUES ('190', 'OTHER_A886. HT 2JN7. 2.5 IN RD', 'pdf', 'data/upload/other/2015/12/14', '344951', '12', '1450116456', '0', '0');
INSERT INTO `tbl_file` VALUES ('191', 'OTHER_A1444. HT# D1A7. 1.500 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '594118', '12', '1450116544', '0', '0');
INSERT INTO `tbl_file` VALUES ('192', 'A1444. HT# D1A7. 1.500 INCH DIA_1', 'pdf', 'data/upload/other/2015/12/14', '594118', '12', '1450117225', '0', '0');
INSERT INTO `tbl_file` VALUES ('193', 'A1444. HT# D1A7. 1.500 INCH DIA_2', 'pdf', 'data/upload/other/2015/12/14', '594118', '12', '1450117360', '0', '0');
INSERT INTO `tbl_file` VALUES ('194', 'OTHER_A1783. HT 252354. 2.500 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '1655154', '12', '1450117446', '0', '0');
INSERT INTO `tbl_file` VALUES ('195', 'OTHER_A1063. HT#5KC2. 2.1250 IN DIA.', 'doc', 'data/upload/other/2015/12/14', '4137984', '12', '1450117749', '0', '0');
INSERT INTO `tbl_file` VALUES ('196', 'OTHER_A747. HT# FS-4876.  2  IN DIA', 'pdf', 'data/upload/other/2015/12/14', '271373', '12', '1450117987', '0', '0');
INSERT INTO `tbl_file` VALUES ('197', 'OTHER_A726. HT E43324', 'pdf', 'data/upload/other/2015/12/14', '334423', '12', '1450118314', '0', '0');
INSERT INTO `tbl_file` VALUES ('198', 'OTHER_A1557. HT H2D4. 2.500 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '573104', '12', '1450118522', '0', '0');
INSERT INTO `tbl_file` VALUES ('199', 'OTHER_A1455. HT D2K4. 3.750 INCH DIA', 'pdf', 'data/upload/other/2015/12/14', '580452', '12', '1450118804', '0', '0');
INSERT INTO `tbl_file` VALUES ('200', 'PDF_DMCM-TLWP-010RA  Retention Block A, Square Twist Lock-2016-01-15', 'pdf', 'data/upload/other/2016/02/12', '256936', '1', '1455294380', '2', '0');
INSERT INTO `tbl_file` VALUES ('202', 'PDF_DMCM-TLWP-011RA  Retention Block B, Square Twist Lock-2016-01-15', 'pdf', 'data/upload/other/2016/02/12', '711053', '1', '1455295410', '2', '0');
INSERT INTO `tbl_file` VALUES ('203', 'DMCM-TLWP-010RA  Retention Block A, Square Twist Lock-2016-01-15_2', 'pdf', 'data/upload/other/2016/02/12', '256936', '1', '1455296039', '2', '0');
INSERT INTO `tbl_file` VALUES ('205', 'OTHER_20160211_114617', 'jpg', 'data/upload/image/2016/02/14', '4668711', '1', '1455472010', '0', '0');
INSERT INTO `tbl_file` VALUES ('206', 'OTHER_20160211_114629', 'jpg', 'data/upload/image/2016/02/14', '4649732', '1', '1455472015', '0', '0');
INSERT INTO `tbl_file` VALUES ('207', 'E-012002431_PartPriceList_2', 'pdf', '/data/pdf/', '7007', '1', '1455508292', '2', '0');
INSERT INTO `tbl_file` VALUES ('208', 'PDF_CCF02292016_0004', 'pdf', 'data/upload/other/2016/03/12', '1214438', '1', '1457793886', '2', '0');
INSERT INTO `tbl_file` VALUES ('209', 'CCF02292016_0004_1', 'pdf', 'data/upload/other/2016/03/12', '1214438', '1', '1457794190', '2', '0');
INSERT INTO `tbl_file` VALUES ('210', 'RFQEXC_RFQSNS1011APR22_2016', 'xlsx', 'data/upload/other/2016/04/22', '52708', '1', '1461329253', '18', '0');
INSERT INTO `tbl_file` VALUES ('211', '18InX6.875X3-12THD_PartPriceList', 'pdf', '/data/pdf/', '7086', '1', '1461329465', '18', '0');
INSERT INTO `tbl_file` VALUES ('212', '18InX6.875X3-12THD_PartPriceList_1', 'pdf', '/data/pdf/', '7086', '1', '1461329629', '18', '0');
INSERT INTO `tbl_file` VALUES ('213', 'PDF_R-1000-20-02-0001-V2', 'pdf', 'data/upload/other/2016/05/03', '70261', '15', '1462299053', '2', '0');
INSERT INTO `tbl_file` VALUES ('214', 'PDF_R-1000-20-02-023', 'pdf', 'data/upload/other/2016/05/03', '79147', '15', '1462300630', '2', '0');
INSERT INTO `tbl_file` VALUES ('215', 'PDF_R-1000-20-02-025', 'pdf', 'data/upload/other/2016/05/03', '77355', '15', '1462300859', '2', '0');
INSERT INTO `tbl_file` VALUES ('216', 'PDF_R-1000-20-02-036', 'pdf', 'data/upload/other/2016/05/03', '82949', '15', '1462301127', '2', '0');
INSERT INTO `tbl_file` VALUES ('217', 'PDF_R-1000-40-02-0009', 'pdf', 'data/upload/other/2016/05/03', '65319', '15', '1462301335', '2', '0');
INSERT INTO `tbl_file` VALUES ('218', 'PDF_R-1000-60-02-0002', 'pdf', 'data/upload/other/2016/05/03', '71482', '15', '1462302251', '2', '0');
INSERT INTO `tbl_file` VALUES ('219', 'PDF_R-1000-40-02-0019', 'pdf', 'data/upload/other/2016/05/03', '82064', '15', '1462302420', '2', '0');
INSERT INTO `tbl_file` VALUES ('220', 'PDF_R-1000-10-02-0015', 'pdf', 'data/upload/other/2016/05/03', '77173', '15', '1462302991', '2', '0');
INSERT INTO `tbl_file` VALUES ('221', 'PDF_R-1000-10-02-0003', 'pdf', 'data/upload/other/2016/05/03', '103906', '15', '1462303259', '2', '0');
INSERT INTO `tbl_file` VALUES ('222', 'PDF_R-1000-10-02-0004-1 - BLANK', 'pdf', 'data/upload/other/2016/05/03', '79257', '15', '1462303555', '2', '0');
INSERT INTO `tbl_file` VALUES ('223', 'PDF_R-1000-40-02-0005', 'pdf', 'data/upload/other/2016/05/03', '76237', '15', '1462303809', '2', '0');
INSERT INTO `tbl_file` VALUES ('224', 'PDF_R-1000-10-02-0010', 'pdf', 'data/upload/other/2016/05/03', '76621', '15', '1462303994', '2', '0');
INSERT INTO `tbl_file` VALUES ('225', 'PDF_R-1000-40-02-0002', 'pdf', 'data/upload/other/2016/05/03', '72316', '15', '1462304135', '2', '0');
INSERT INTO `tbl_file` VALUES ('226', 'PDF_R-1000-10-02-0003 - BLANK', 'pdf', 'data/upload/other/2016/05/04', '87943', '15', '1462366805', '2', '0');
INSERT INTO `tbl_file` VALUES ('227', 'PDF_R-1000-20-02-006', 'pdf', 'data/upload/other/2016/05/04', '120595', '15', '1462367374', '2', '0');
INSERT INTO `tbl_file` VALUES ('228', 'PDF_R-1000-20-02-003', 'pdf', 'data/upload/other/2016/05/04', '120183', '15', '1462368264', '2', '0');
INSERT INTO `tbl_file` VALUES ('229', 'PDF_R-1000-20-02-028', 'pdf', 'data/upload/other/2016/05/04', '89786', '15', '1462368561', '2', '0');
INSERT INTO `tbl_file` VALUES ('230', 'PDF_R-1000-20-02-022', 'pdf', 'data/upload/other/2016/05/04', '89174', '15', '1462368845', '2', '0');
INSERT INTO `tbl_file` VALUES ('231', 'R-1000-10-02-0010_PartPriceList', 'pdf', '/data/pdf/', '6945', '1', '1462441580', '18', '0');
INSERT INTO `tbl_file` VALUES ('232', 'R-1000-40-02-0002_PartPriceList', 'pdf', '/data/pdf/', '7015', '1', '1462441900', '18', '0');
INSERT INTO `tbl_file` VALUES ('233', 'R-000-10-02-0014_PartPriceList', 'pdf', '/data/pdf/', '6926', '1', '1462443122', '18', '0');
INSERT INTO `tbl_file` VALUES ('234', 'R-1000-10-02-0015_PartPriceList', 'pdf', '/data/pdf/', '6932', '1', '1462443301', '18', '0');
INSERT INTO `tbl_file` VALUES ('235', 'RFQEXC_RFQ_May3_2016_1InAluminum_parts', 'xlsx', 'data/upload/other/2016/05/05', '53362', '1', '1462453827', '18', '0');
INSERT INTO `tbl_file` VALUES ('236', 'R-1000-10-02-0015_PartPriceList_1', 'pdf', '/data/pdf/', '6962', '1', '1462454511', '18', '0');
INSERT INTO `tbl_file` VALUES ('237', 'R-000-10-02-0014_PartPriceList_1', 'pdf', '/data/pdf/', '6966', '1', '1462454668', '18', '0');
INSERT INTO `tbl_file` VALUES ('239', 'PDF_R-1000-20-02-033', 'pdf', 'data/upload/other/2016/05/05', '70923', '15', '1462471623', '2', '0');
INSERT INTO `tbl_file` VALUES ('240', 'R-1000-10-02-0006_PartPriceList', 'pdf', '/data/pdf/', '7049', '1', '1462626431', '18', '0');
INSERT INTO `tbl_file` VALUES ('241', 'R-1000-10-02-0013_PartPriceList', 'pdf', '/data/pdf/', '7046', '1', '1462626552', '18', '0');
INSERT INTO `tbl_file` VALUES ('242', 'R-1000-40-02-0002_PartPriceList_1', 'pdf', '/data/pdf/', '7009', '1', '1462627988', '18', '0');
INSERT INTO `tbl_file` VALUES ('243', 'R-1000-10-02-0010_PartPriceList_1', 'pdf', '/data/pdf/', '7013', '1', '1462628378', '18', '0');
INSERT INTO `tbl_file` VALUES ('244', 'R-1000-10-02-0015_PartPriceList_2', 'pdf', '/data/pdf/', '7013', '1', '1462628693', '18', '0');
INSERT INTO `tbl_file` VALUES ('245', 'R-000-10-02-0014_PartPriceList_2', 'pdf', '/data/pdf/', '7016', '1', '1462630070', '18', '0');
INSERT INTO `tbl_file` VALUES ('246', 'RFQEXC_RFQMay3_2016_Gears', 'xlsx', 'data/upload/other/2016/05/14', '52870', '1', '1463244299', '18', '0');
INSERT INTO `tbl_file` VALUES ('247', 'REY4.25ELC_PartPriceList', 'pdf', '/data/pdf/', '7026', '1', '1469466575', '18', '0');
INSERT INTO `tbl_file` VALUES ('248', '4068R1_PartPriceList', 'pdf', '/data/pdf/', '7377', '1', '1472745936', '18', '0');
INSERT INTO `tbl_file` VALUES ('249', 'PDF_20150204-luyen-thi-ielts-reading-anh-1', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475341609', '2', '0');
INSERT INTO `tbl_file` VALUES ('250', 'Inv_20150204-luyen-thi-ielts-reading-anh-1', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475341627', '5', '0');
INSERT INTO `tbl_file` VALUES ('251', 'SCAR_PTTHCNN_logo', 'png', 'data/upload/image/2016/10/01', '54068', '1', '1475344739', '9', '0');
INSERT INTO `tbl_file` VALUES ('252', 'PTTHCNN_logo_3', 'png', 'data/upload/image/2016/10/01', '54068', '1', '1475344832', '9', '1');
INSERT INTO `tbl_file` VALUES ('253', 'SHEET_IMG_8721s', 'jpg', 'data/upload/image/2016/10/01', '215986', '1', '1475344850', '10', '1');
INSERT INTO `tbl_file` VALUES ('254', 'TOOL_PTTHCNN_logo', 'png', 'data/upload/image/2016/10/01', '54068', '1', '1475344923', '11', '1');
INSERT INTO `tbl_file` VALUES ('255', 'HAS_IMG_8721s', 'jpg', 'data/upload/image/2016/10/01', '215986', '1', '1475344937', '14', '1');
INSERT INTO `tbl_file` VALUES ('256', 'OTHER_10313596_680312728708103_6807323123766682919_n', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475350825', '0', '0');
INSERT INTO `tbl_file` VALUES ('257', '10313596_680312728708103_6807323123766682919_n_1', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475350936', '0', '0');
INSERT INTO `tbl_file` VALUES ('259', 'OTHER_Asset-Tracking-backup sept 21', 'xlsx', 'data/upload/other/2016/10/01', '629674', '1', '1475351173', '0', '0');
INSERT INTO `tbl_file` VALUES ('260', '20150204-luyen-thi-ielts-reading-anh-1_1', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475351323', '0', '0');
INSERT INTO `tbl_file` VALUES ('261', '10313596_680312728708103_6807323123766682919_n_2', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475351401', '0', '0');
INSERT INTO `tbl_file` VALUES ('262', '10313596_680312728708103_6807323123766682919_n_3', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475351432', '0', '0');
INSERT INTO `tbl_file` VALUES ('264', '10313596_680312728708103_6807323123766682919_n_4', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475351494', '0', '0');
INSERT INTO `tbl_file` VALUES ('265', '20150204-luyen-thi-ielts-reading-anh-1_2', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475352002', '5', '0');
INSERT INTO `tbl_file` VALUES ('266', 'Asset-Tracking-backup sept 21_2', 'xlsx', 'data/upload/other/2016/10/01', '629674', '1', '1475352003', '0', '0');
INSERT INTO `tbl_file` VALUES ('267', 'SCAR_Asset-Tracking-backup sept 21', 'xlsx', 'data/upload/other/2016/10/01', '629674', '1', '1475352021', '9', '0');
INSERT INTO `tbl_file` VALUES ('268', 'MCDS_20150204-luyen-thi-ielts-reading-anh-1', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475352043', '8', '1');
INSERT INTO `tbl_file` VALUES ('269', 'PO_10313596_680312728708103_6807323123766682919_n', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475352067', '4', '0');
INSERT INTO `tbl_file` VALUES ('270', 'BP_20150204-luyen-thi-ielts-reading-anh-1', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475352074', '7', '0');
INSERT INTO `tbl_file` VALUES ('271', 'MTN_10313596_680312728708103_6807323123766682919_n', 'jpg', 'data/upload/image/2016/10/01', '66387', '1', '1475352093', '12', '0');
INSERT INTO `tbl_file` VALUES ('272', '20150204-luyen-thi-ielts-reading-anh-1_3', 'jpg', 'data/upload/image/2016/10/01', '90306', '1', '1475352094', '0', '0');
...
-- ----------------------------
-- Table structure for `tbl_graphic`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_graphic`;
...
-- ----------------------------
-- Records of tbl_graphic
-- ----------------------------
INSERT INTO `tbl_graphic` VALUES ('14', 'hong', '4', 'Lan 4', null, null, 'ASSET_26', '1', null, '1475351735', '1');
INSERT INTO `tbl_graphic` VALUES ('15', '13', '3', 'Test only', '12', '264', 'ASSET_26', '1', '1475352103', '1475351735', '1');
INSERT INTO `tbl_graphic` VALUES ('16', 'nam', '4', 'Tôi đến đây', '3333', null, '', '1', '1475374373', '1475374361', '1');
INSERT INTO `tbl_graphic` VALUES ('17', 'bcd', '3', 'Test 3', '3', null, 'ASSET_26', '1', '1475351735', '1475351735', '1');

-- ----------------------------
-- Table structure for `tbl_graphic_category`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_graphic_category`;
CREATE TABLE `tbl_graphic_category` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `status` tinyint(1) unsigned NOT NULL,
  `created_time` int(11) unsigned NOT NULL,
...
-- ----------------------------
-- Records of tbl_graphic_category
-- ----------------------------
INSERT INTO `tbl_graphic_category` VALUES ('1', 'Graphic Category 1', '1', '12');
INSERT INTO `tbl_graphic_category` VALUES ('2', 'Graphic Category 2', '1', '12');
INSERT INTO `tbl_graphic_category` VALUES ('3', 'Graphic Category 3', '1', '1429035668');
INSERT INTO `tbl_graphic_category` VALUES ('4', 'Graphic Category 4', '1', '1429035677');

-- ----------------------------
-- Table structure for `tbl_graphic_file`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_graphic_file`;
CREATE TABLE `tbl_graphic_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `graphic_id` int(11) NOT NULL,
  `file_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_graphic_file` (`graphic_id`,`file_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of tbl_graphic_file
-- ----------------------------
INSERT INTO `tbl_graphic_file` VALUES ('3', '15', '268');
INSERT INTO `tbl_graphic_file` VALUES ('4', '15', '269');
INSERT INTO `tbl_graphic_file` VALUES ('5', '15', '270');
INSERT INTO `tbl_graphic_file` VALUES ('6', '15', '271');
INSERT INTO `tbl_graphic_file` VALUES ('7', '15', '272');
...
-- ----------------------------
INSERT INTO `tbl_store` VALUES ('1', 'Phil', 'Philip Kul', 'Ball Media', 'LA, US', '', '', '0', '', 'US', 'phil@example.com', '123', '1212112', '0', '1', '1426097092', null, null);
INSERT INTO `tbl_store` VALUES ('2', 'CUSTOMER1 TEST', 'JOHN TEST', 'CUSTOMER TEST COMPANY', '202-446 grey st', '', 'Brantford', '59', 'N3S 7L6', 'Canada', 'c1@ballmedia.com', '5197550853', '5197568641', '0', '1', '1429086792', null, null);
INSERT INTO `tbl_store` VALUES ('3', 'HungTN', 'Hung', 'HVD companry', 'Hanoi VN', '', 'Hanoi', '2', '100000', 'US', 'hungtn87@gmail.com', '0909098788989', '9987978', '0', '1', '1430448573', null, null);
INSERT INTO `tbl_store` VALUES ('4', 'GFW', 'DAN HERTEIS', 'GFW TECHNOLOGIES INC.', '485 Conestoga Blvd.', '', 'Cambridge', '59', 'N1R 7P4', 'Canada', 'dherteis@gfw.ca', '519-740-8680', '519-740-7658', '0', '1', '1442329851', null, null);
INSERT INTO `tbl_store` VALUES ('5', 'SNS INDUSTRIAL', 'CINDY HANDCOCK', 'SNS INDUSTRIAL GROUP', '142 Sugar Maple Rd.', '', 'St. George', '59', 'N0E 1N0', 'Canada', 'cindy.hancock@snsindustrial.com', '(519) 448-3055', '519-448-3060', '0', '1', '1442406741', null, null);
INSERT INTO `tbl_store` VALUES ('6', 'GFW', 'Daniel Adam', 'GWF TECHNOLOGIES', '485 Conestoga Boulevard', '', 'Cambridge', '59', 'N1P 7P4', 'Canada', 'dadam@gfw.ca', '519-740-8680', '519-740-7658', '0', '1', '1443875474', null, null);
INSERT INTO `tbl_store` VALUES ('7', 'Morrow Crane', 'Jason Stewart', 'Morrow Crane', '', '', 'Brantford', '59', '', 'Canada', '', '', '', '0', '1', '1446835918', null, null);
INSERT INTO `tbl_store` VALUES ('8', 'Kuriyama Canada Inc.', 'Walter Vogt', 'Kuriyama Canada Inc.', '140 Roy Blvd.', '', 'Brantford', '59', 'N35 7W9', 'Canada', 'kciwalt@kuritech.com', '519-759-1673  x114', '519-759-7478', '0', '1', '1448410429', null, null);
INSERT INTO `tbl_store` VALUES ('9', 'SNS INDUSTRIAL (SAM)', 'Sam Sheets', 'SNS INDUSTRIAL', '142 Sugar Maple Rd.', '', 'St. George', '59', 'N0E 1N0', 'Canada', 'sam.sheets@snsindustrial.com', '(519) 448-3055', '519-448-3060', '0', '1', '1448452013', null, null);
INSERT INTO `tbl_store` VALUES ('10', 'DOMITE', 'Chris Otway', 'DOMITE (MMI)', '20 Lee Ave.', '', 'Paris', '59', 'N3L 3T6', 'Canada', 'chris@domite.com', '519-442-3129   Cell ', '519-442-2604', '0', '1', '1455293223', null, null);
INSERT INTO `tbl_store` VALUES ('11', 'SOLARSHIP INC', 'Andrew Bezkorow', 'SOLARSHIP INC', '175 Aviation Avenue,  Brantford Municipal Airport', '', 'Brantford', '59', 'N3T 5L7', 'Canada', 'abezkorow@solarship.com', '519-751-2590', '', '0', '1', '1457728744', null, null);
INSERT INTO `tbl_store` VALUES ('12', 'Redetec (David L)', 'David Laciak', 'Redetec Inc.', '442-T DUFFERIN STREET', '', 'TORONTO', '59', 'M6K 2A3', 'CANADA', 'david@redetec.com', '416-788-2403', '', '0', '1', '1462294139', null, null);
INSERT INTO `tbl_store` VALUES ('13', 'Reynolds', 'Don Reynolds', 'Reynolds Custom Machine', '155 Sugar Maple Rd.', '', 'St. George', '59', 'N0E 1N0', 'Canada', 'don@reynoldsmachine.ca', '519-448-1180', '519-448-1006', '0', '1', '1469461499', null, null);
INSERT INTO `tbl_store` VALUES ('14', 'North Robotics', 'Allan Hendry', 'North Robotics', '1731 Mortimer St.', 'Vp', 'Vancouver', '53', 'V8P 3AP', 'Canada', 'ahendry@northrobotics.com', '250-508-7037', '12345', '3', '1', '1472745027', null, null);
...
-- ----------------------------
INSERT INTO `tbl_store_file` VALUES ('1', '14', '250');
INSERT INTO `tbl_store_file` VALUES ('2', '14', '255');
...
-- Records of tbl_tier
-- ----------------------------
INSERT INTO `tbl_tier` VALUES ('1', 'Tier 1', '1', '6');
INSERT INTO `tbl_tier` VALUES ('2', 'Tier 2', '1', '6');
INSERT INTO `tbl_tier` VALUES ('3', 'Tier 3', '1', '1428316533');
INSERT INTO `tbl_tier` VALUES ('4', 'Tier 4', '1', '1428336262');
INSERT INTO `tbl_tier` VALUES ('6', 'Tier 5', '1', '1475341260');

...
class EExcelBehavior extends CBehavior {
     ...
     */
    public function toExcel($model = null, $columns = array(), $title = null, $documentDetails = array(), $exportType = 'Excel2007', $grid_mode, $stream = true, $filename = null) {
        ...
        if ($filename != null) {
            return [
                ...
                'dirname' => 'data/export/',
                'file_url' => Yii::app()->getBaseUrl() . '/data/export/' . $filename . '.'.$extenstion,
                'file_absolute_url' => Yii::app()->getBaseUrl(true) . '/data/export/' . $filename . '.'.$extenstion,
            ];
        }

...
<table style="font-family:Arial, Helvetica,san-serif;font-size:10pt" class="project_detail_table" border="1" cellpadding="5" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 70%"><?= $qa->customer_spec_sensor ? "Yes" : "No"?></td>
        </tr>
        
        <?php if($qa->customer_spec_sensor):?>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->customer_spec_sensor_other?></td>
        <?php endif;?>
            
        <tr>
            <td style="width: 30%"><b>Does the Customer require a pre-shipment sample?</b></td>
            <td style="width: 70%"><?= $qa->customer_require_preship ? "Yes" : "No"?></td>
        </tr> 
        
        <tr>
            <td style="width: 30%"><b>Physical specifications of product i.e, density, flowability etc.</b></td>
            <td style="width: 70%"><?= $qa->physical_spec_product ? "Yes" : "No"?></td>
        </tr>
        
        <tr>
            <td style="width: 30%"><b>Product spec sheet reviewed?</b></td>
            <td style="width: 70%"><?= $qa->product_spec_sheet ? "Yes" : "No"?></td>
        </tr>
        
         <?php if($qa->product_spec_sheet):?>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->product_spec_sheet_other?></td>
        <?php endif;?>
            
        <tr>
            <td style="width: 30%"><b>Allergen status reviewed?</b></td>
            <td style="width: 70%"><?= $qa->allergen_status ? "Yes" : "No" ?></td>
        </tr>

        <?php if ($qa->allergen_status): ?>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->allergen_status_other ?></td>
        <?php endif; ?>
          
        <?php if(true):?>    
        <tr>
            <td style="width: 30%"><b>Allergen status reviewed?</b></td>
            <td style="width: 70%"><?= $qa->customer_provide_confirm ? "Yes" : "No" ?></td>
        </tr>
        <?php endif;?>
        ...
        <tr>
            <td style="width: 30%"><b>Has the Customer provided labelling requirements for primary packaging?</b></td>
            <td style="width: 70%"><?= $qa->customer_provide_label_primary_pack ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->customer_provide_label_primary_pack) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->customer_provide_label_primary_pack_other ?></td>
        </tr>
        <?php endif;?>
        ...
        <tr>
            ...
            <td style="width: 70%"><?= $qa->customer_provide_label_inner_pack ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->customer_provide_label_inner_pack) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->customer_provide_label_inner_pack_other ?></td>
        </tr>
        <?php endif;?>
        ...
        <tr>
            ...
            <td style="width: 70%"><?= $qa->customer_provide_label_shipper ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->customer_provide_label_shipper) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->customer_provide_label_shipper_other ?></td>
        </tr>
        <?php endif;?>
        ...
        <tr>
            ...
            <td style="width: 70%"><?= $qa->product_have_spec_claim ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->product_have_spec_claim) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->product_have_spec_claim_other ?></td>
        </tr>
        <?php endif;?>
        
        <tr>
            <td style="width: 30%"><b>Any special handling instructions? ex. Dry clean before due to allergen etc.</b></td>
            <td style="width: 70%"><?= $qa->spec_hand_instruc ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->spec_hand_instruc) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->spec_hand_instruc_other ?></td>
        </tr>
        <?php endif;?>
            
        <tr>
            <td style="width: 30%"><b>Has the Customer requested special shipping requirrements?</b></td>
            <td style="width: 70%"><?= $qa->customer_request_spec_ship ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->customer_request_spec_ship) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->customer_request_spec_ship_other ?></td>
        </tr>
        <?php endif;?>
        ...
        <tr>
            ...
            <td style="width: 70%"><?= $qa->product_have_npn ? "Yes" : "No" ?></td>
        </tr>
        <?php if($qa->product_have_npn) :?>
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 70%"><?= $qa->product_have_npn_other ?></td>
        </tr>
        <?php endif;?>
            
        <tr>
            <td style="width: 30%"><b>Is this product NSF certified for sports?</b></td>
            <td style="width: 70%"><?= $qa->product_nsf_for_sport ? "Yes" : "No" ?></td>
        </tr>
    </tbody>
</table>
<br/>

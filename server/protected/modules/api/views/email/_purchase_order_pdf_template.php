...
.order_detail_pdf table, .order_detail_pdf td, .order_detail_pdf th  {
			...
			<td style="width: 50%; vertical-align: bottom;">
				<table style="width: 100%; text-align: right;">
					...
					<tbody>
						<tr>
							<td>Order #:</td>
							<td><b><?php echo $purchase_order->po_code;?></b></td>
						</tr>
						<tr>
							<td>Client name:</td>
							<td><b><?php echo $purchase_order->client->contact_name;?></b></td>
						</tr>
						<tr>
							<td>Address:</td>
							<td><b><?php echo $purchase_order->client->address1;?></b></td>
						</tr>
						<tr>
							<td>Company name:</td>
							<td><b><?php echo $purchase_order->client->company_name;?></b></td>
						</tr>
						<tr>
							<td>Phone:</td>
							<td><b><?php echo $purchase_order->client->phone;?></b></td>
						</tr>
						<tr>
							<td>Email:</td>
							<td><b><?php echo $purchase_order->client->email;?></b></td>
						</tr>
					</tbody>
				</table>
			</td>

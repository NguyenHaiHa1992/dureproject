    ...
    function ($scope, $timeout, $http, $location, $rootScope, BASE_URL, $state, $stateParams, FileUploader) {
        ...
        $scope.selectPage = function (page) {
            ...
            var post_information = {
                ...
                'sort_attribute': $scope.sort.attribute,
                'sort_type': $scope.sort.type,
                'cat_id': $scope.search_file.cat_id,
                'filename': $scope.search_file.filename,
                'restricted': $scope.search_file.restricted
            };
            $scope.getFiles(post_information);
        };
        ...
        $scope.sort = function (sort_attribute) {
            ...
            var post_information = {
                ...
                'sort_attribute': $scope.sort.attribute,
                'sort_type': $scope.sort.type,
                'id': $scope.search_file.id,
                'name': $scope.search_file.name,
                'restricted': $scope.search_file.restricted,
                'created': $scope.search_file.created,
            };
            $scope.getFiles(post_information);
        };

        $scope.search = function () {
            post_information.cat_id = $scope.search_file.cat_id;
            post_information.filename = $scope.search_file.filename;
            post_information.restricted = $scope.search_file.restricted;
        ...
        uploader.onBeforeUploadItem = function (item) {
            ...
            if (typeof $scope.file_cat_ids[index] != 'undefined' 
                    && typeof $scope.file_restricted_list[index] != 'undefined'){
                item.formData.push({file_cat_id: $scope.file_cat_ids[index]});
                item.formData.push({file_restricted: $scope.file_restricted_list[index]});
            }
            else {
        ...
        $scope.remove = function (item) {
            ...
            if (item.id == undefined) {
                ...
                sweetAlert({
                    title: "Are you sure?",
                    text: "All relation of this file will also be deleted. You will not be able to recover this file!",
                    type: "warning",
